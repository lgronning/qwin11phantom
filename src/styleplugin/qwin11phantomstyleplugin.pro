QT += core gui widgets
CONFIG += plugin
TARGET = qwin11phantomstyleplugin
TEMPLATE = lib
...
include(../qwin11phantom/qwin11phantom.pri)

SOURCES += qwin11phantomstyleplugin.cpp

HEADERS += qwin11phantomstyleplugin.h

OTHER_FILES += qwin11phantomstyleplugin.json
